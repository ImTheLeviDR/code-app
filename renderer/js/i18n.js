...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'settings.providers.subtitleAfter': ' for free and paid models.',
      'settings.providers.opencodeKeyNoteBefore': 'Optional for free models. Get a key at ',
      'settings.providers.opencodeKeyNoteAfter': ' to raise quota limits.',
      'settings.providers.syncButton': 'Sync providers',
      'settings.providers.syncMeta': '{connected} connected · Free models work without a key',
      ...
      'settings.providers.status.optionalKey': 'Optional key',
      'settings.providers.status.connectedFree': 'Connected (free tier)',
      ...
      'error.model.missing_api_key': 'This model needs an API key. Add it in Settings → Providers and click Sync, or pick a free OpenCode model.',
    ...
    hu: {
      ...
      'settings.providers.subtitleAfter': ' az ingyenes és fizetős modellekhez.',
      'settings.providers.opencodeKeyNoteBefore': 'Az ingyenes modellekhez opcionális. Kulcsot itt kapsz: ',
      'settings.providers.opencodeKeyNoteAfter': ' — magasabb kvótához.',
      'settings.providers.syncButton': 'Szolgáltatók szinkronizálása',
      'settings.providers.syncMeta': '{connected} csatlakoztatva · Az ingyenes modellek kulcs nélkül is működnek',
      ...
      'settings.providers.status.optionalKey': 'Opcionális kulcs',
      'settings.providers.status.connectedFree': 'Csatlakoztatva (ingyenes)',
      ...
      'error.model.missing_api_key': 'Ehhez a modellhez API-kulcs kell. Add meg a Beállítások → Szolgáltatók menüben, szinkronizálj, vagy válassz ingyenes OpenCode modellt.',
