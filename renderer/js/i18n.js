...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'settings.logs.subtitle': 'Recent errors with stack traces, context, and full diagnostic details.',
      'settings.logs.filterLabel': 'Filter by level',
      'settings.logs.filterAll': 'All levels',
      'settings.logs.filterError': 'Errors',
      'settings.logs.filterWarn': 'Warnings',
      ...
      'settings.logs.clearConfirm': 'Delete all saved log entries?',
      'settings.logs.clearAction': 'Clear',
      'settings.logs.recent': 'Recent entries',
      'settings.logs.loading': 'Loading logs…',
      'settings.logs.empty': 'No log entries yet.',
      'settings.logs.loadFailed': 'Could not load logs.',
      'settings.logs.unavailable': 'Logging is not available in this environment.',
      ...
      'error.model.provider_connection': 'Could not reach the provider. Check your internet connection and provider settings in Settings → Providers.',
      ...
      'toast.logsClearFailed': 'Could not clear logs',
      'toast.logsOpenFolderFailed': 'Could not open log folder',
    ...
    hu: {
      ...
      'settings.logs.title': 'Naplók',
      'settings.logs.subtitle': 'Legutóbbi hibák stack trace-szel, kontextussal és teljes diagnosztikai részletekkel.',
      'settings.logs.filterLabel': 'Szűrés szint szerint',
      'settings.logs.filterAll': 'Minden szint',
      'settings.logs.filterError': 'Hibák',
      'settings.logs.filterWarn': 'Figyelmeztetések',
      'settings.logs.filterInfo': 'Információ',
      'settings.logs.refresh': 'Frissítés',
      'settings.logs.copy': 'Naplók másolása',
      'settings.logs.openFolder': 'Naplómappa megnyitása',
      'settings.logs.clear': 'Naplók törlése',
      'settings.logs.clearConfirm': 'Törlöd az összes mentett naplóbejegyzést?',
      'settings.logs.clearAction': 'Törlés',
      'settings.logs.recent': 'Legutóbbi bejegyzések',
      'settings.logs.loading': 'Naplók betöltése…',
      'settings.logs.empty': 'Még nincs naplóbejegyzés.',
      'settings.logs.loadFailed': 'Nem sikerült betölteni a naplókat.',
      'settings.logs.unavailable': 'A naplózás nem érhető el ebben a környezetben.',
      ...
      'error.model.provider_connection': 'Nem sikerült elérni a szolgáltatót. Ellenőrizd az internetkapcsolatot és a szolgáltató beállításait a Beállítások → Szolgáltatók menüben.',
      ...
      'toast.logsCopied': 'Naplók a vágólapra másolva',
      'toast.logsCleared': 'Naplók törölve',
      'toast.logsClearFailed': 'Nem sikerült törölni a naplókat',
      'toast.logsOpenFolderFailed': 'Nem sikerült megnyitni a naplómappát',
